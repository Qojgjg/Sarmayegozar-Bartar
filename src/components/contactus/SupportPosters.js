        ...
        <div className="flex justify-between items-center">
          <div className="w-[354px] h-[58px] bg-gradient-to-l from-[rgba(236,236,236,1)] to-[rgba(236,236,236,0)] rounded-[10px] p-[1px]">
            <div className="w-full h-full flex items-center bg-white rounded-[10px] px-[19px] py-[17px] gap-[14px]">
              <span>پشتیبان شماره ۱</span>
              <span>SGB_TECHNICALSUPPORT@</span>
              <div className="w-[92px] h-[50px] flex flex-col justify-center bg-primary-btn-color rounded-[10px]">
                <img className="mx-auto" src={require("../../assets/img/Telegram.png")} alt="Telegram" />
              </div>
            </div>
          </div>
        </div>
